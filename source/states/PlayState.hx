...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Dies Of Laughter', 0.2], //From 0% to 19%
		['Ugh', 0.4], //From 20% to 39%
		['Get Good', 0.5], //From 40% to 49%
		['Ok', 0.6], //From 50% to 59%
		['You Kinda Got The Hang Of It', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Great', 0.9], //From 80% to 89%
		['Sick!', 1], //From 90% to 99%
		['OMEGA ASTRONAUT', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
